  ...
  seoul: {
    ...
    highlights:[
      { name:'Gangnam Beauty Belt', emoji:'💉',
        youtube:'VBkovUtZaRA', short:true,
        link:'https://www.google.com/maps/search/?api=1&query=Gangnam+Beauty+Clinics+Seoul',
      ...
      { name:'Gyeongbokgung Palace', emoji:'🏯',
        youtube:'XwbCZTB_Z3o', short:true,
        link:'https://www.google.com/maps/search/?api=1&query=Gyeongbokgung+Palace+Seoul',
      ...
      { name:'Bukhansan National Park', emoji:'⛰️',
        youtube:'Ja-ASb8Oe0s', short:false,
        link:'https://www.google.com/maps/search/?api=1&query=Bukhansan+National+Park+Seoul',
  ...
  phnompenh: {
    ...
    highlights:[
      { name:'Royal Palace & Silver Pagoda', emoji:'👑',
        youtube:'3Qu6UzNTr5s', short:true,
        link:'https://www.google.com/maps/search/?api=1&query=Royal+Palace+Silver+Pagoda+Phnom+Penh',
      ...
      { name:'Tuol Sleng Genocide Museum', emoji:'🕯️',
        youtube:'kW2Lu_qrvCI', short:true,
        link:'https://www.google.com/maps/search/?api=1&query=Tuol+Sleng+Genocide+Museum+Phnom+Penh',
      ...
      { name:'Central Market (Phsar Thmey)', emoji:'🛒',
        youtube:'T6hssPssh5I', short:true,
        link:'https://www.google.com/maps/search/?api=1&query=Central+Market+Phsar+Thmey+Phnom+Penh',
